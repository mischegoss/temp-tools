...
class GeminiService:
    ...
    def _should_use_relationships(self, message: str, question_type: str) -> bool:
        ...
        if question_type in ['support_request', 'account_issue', 'system_issue', 'billing_issue', 'urgent_issue', 'bug_report']:
            return False
    ...
    def chat(self, chat_request: ChatRequest) -> ChatResponse:
        """Enhanced chat method with comprehensive support routing"""
        start_time = datetime.now()
        
        try:
            # Step 1: Detect question type with enhanced patterns - FIXED: Use self.detect_question_type
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "approach": "enhanced_support_routing_with_relationship_search",
            ...
            "statistics": {
                ...
                "support_routing_patterns": len([p for patterns in [
                    ...
                    "billing_issue", "urgent_issue", "bug_report"
                ] for p in patterns])
            }
        }
    
    def test_connection(self) -> Dict[str, Any]:
        """Test the enhanced Gemini API connection with comprehensive support routing"""
        try:
            if not self.ready:
            ...
            test_response = self.model.generate_content(
                "Respond with: 'I'd be glad to help you test the connection! The enhanced RANI assistant is ready with comprehensive support routing and smart documentation search.'"
            )
            ...
            if test_response.text:
                ...
                return {
                    ...
                    "features": "Comprehensive support routing, relationship-enhanced search, documentation-bounded responses",
                    "relationship_data_status": f"{search_stats.get('chunks_with_relationships', 0)} chunks with relationship data available",
                    "support_routing": "6 categories of issues automatically routed to support"
                }
            else:
