...
Fixed for clean responses and proper support routing
"""
...
# UNIFIED RESPONSE FORMATS - Revised for clean responses and proper support routing
RESPONSE_FORMATS = {
    "how_to": """
...
# HARDCODED RESPONSES FOR IMMEDIATE SUPPORT ROUTING - Unchanged
...
BILLING_ISSUE_RESPONSE = """I'd be glad to help you with your billing or subscription question.

**For billing, licensing, and subscription matters:** Use the **"Copy Chat & Create Support Ticket"** button below. This will connect you with specialists who can:

- Review your subscription status
- Address billing questions
- Resolve payment issues
- Handle license upgrades
- Provide account management assistance

**Other ways to reach support:**
- Click on **"Support"** in the help.resolve.io navigation menu
- Click on **"Support"** in the Knowledge base section of the Navigation Bar in the Actions platform

Billing and subscription matters require secure account verification that only our support team can handle."""
