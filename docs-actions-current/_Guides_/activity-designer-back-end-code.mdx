...
In this example, you'll add the backend code to an *Active Directory Add to Group* activity. To access the JSON code for the frontend code to design the UI for this activity, visit the [Guide: Frontend Code in the Activity Designer](./Activity-Designer-Frontend-Code.mdx).
