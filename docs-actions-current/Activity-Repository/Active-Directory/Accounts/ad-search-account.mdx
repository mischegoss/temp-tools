---
sidebar_position: 10
id: ad-search-account
title: AD Search Account
---

## Activity Description

Searches for a specific account's location in the Active Directory's hierarchy.
...
* **Account Type** – the account's type (e.g., user/computer).
