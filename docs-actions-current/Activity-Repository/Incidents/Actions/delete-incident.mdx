...
Deletes an incident from the Resolve Actions Dev database.

## Settings


* **Use Current Incident/Use Another Incident** – Determines whether to delete the incident that triggered the workflow, or another incident.
