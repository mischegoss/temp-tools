---
sidebar_position: 10
id: get-number-of-incident-instances
title: Get Number of Incident Instances
---

## Activity Description

Returns a specific incident's number of concurrent instances.

## Settings


* **Use Current Incident/Use Another Incident** – Determines whether to return the number of instances of the incident that triggered the workflow, or another incident.
