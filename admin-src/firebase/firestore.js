// src/firebase/firestore.js - Updated with template-specific fields and new video gallery fields
...
/**
 * Default video data structure with template-specific fields
 */
const getDefaultVideoData = () => ({
  ...
  template: 'instructional', // Default to instructional
  learningObjectives: '',
  estimatedTime: '',
  transcript: '',
...
export const getVideo = async videoId => {
  try {
    ...
    if (docSnap.exists()) {
      ...
      // Merge with defaults to ensure all template fields exist
      const mergedData = {
        ...defaultData,
        ...data,
