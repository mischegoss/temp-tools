...
title: Web Search Connection Configuration
description: A guide to configuring Web Search to feed Rita Go's Knowledge Articles.
sidebar_position: 20
keywords: [
    knowledge articles,
    connection sources,
...
tags: [knowledge articles, connection sources, web search]
