...
// Theme helpers - using Rita Go colors (UPDATED to blue-black)
...
const getRitaGoFocusColor = () => {
  return '#040720' // UPDATED: Using blue-black instead of blue
}
                      ...
                      <div style={{ marginTop: '6px' }}>
                        <Chip
                          ...
                          style={{
                            height: '20px',
                            fontSize: '10px',
                            backgroundColor: '#04072020', // Using blue-black with transparency
