...
export const homePageData = [
  {
    ...
    description: 'Orchestrate and automate IT workflows',
    icon: <DocumentationIcon />,
    link: '/learning/actions',
  },
  {
    title: ['Explore', 'RITA Go'],
    description: 'Trial version of RITA, our new AI-powered agent',
    icon: <LearningIcon />,
    link: '/learning/rita-go/',
  },
  {
    title: ['Learning', 'Hub'],
    description: 'Learn more about all Resolve products',
