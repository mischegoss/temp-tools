...
// Import Express chatbot manager (API now ready)
...
const ProductChatbotRenderer = ({ productType }) => {
  switch (productType) {
    ...
    case 'express':
      return <ExpressChatbotManager />

    case 'insights':
      // 🚧 Insights API not built yet
...
const RealChatbotDisplay = () => {
  ...
  React.useEffect(() => {
    ...
    if (detected === 'pro') {
      ...
      console.log('🎯 Express chatbot loaded for route:', location.pathname)
...
export default function Root({ children }) {
  return (
    <>
      ...
      {/* 
        Product chatbots:
        ✅ Pro: https://pro-chatbot-api-146019630513.us-central1.run.app
        ✅ Express: https://express-chatbot-api-1080349826988.us-central1.run.app
