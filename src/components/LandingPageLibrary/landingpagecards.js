// Simple LandingPageLibrary/landingpagecards.js - Exact Original + Minimal Isolation
...
const LandingPageCards = ({ resources = [], hideSection = false }) => {
  ...
  // Simple hover state - exactly like original
  ...
  // ORIGINAL helper functions - exactly the same
  ...
  const getDualFooterColor = resource => {
    return 'linear-gradient(135deg, #0066FF 0%, #00B8DE 100%)'
  }
