...
export const bannerData = {
  ...
  message: 'New in Resolve Actions: Check out our new Slack integration',

  // What the button says
  buttonText: 'Review docs',

  // Where clicking the button takes users (must start with /)
  buttonLink:
    '/actions/Developing-Custom-Activities/Activity-Guides/Slack-Integration/configuring-the-slack-integration/',
