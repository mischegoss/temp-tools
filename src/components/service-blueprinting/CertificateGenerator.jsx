                ...
                {pdfGenerated && (
                  <button
                    onClick={() => {
                      ...
                      const title = `I completed the Service Blueprinting Essentials course!`
                      const description = `I'm excited to share that I've completed the Service Blueprinting Essentials course. Check it out!`
