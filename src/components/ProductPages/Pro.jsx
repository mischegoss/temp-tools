// @site/src/components/ProductPages/Pro/index.jsx
...
import { learningPaths } from '@site/src/components/Data/LearningPathsPro'

// Import the SVG directly inside the component
import ProLogo from '@site/static/img/Resolve-Actions-Pro-Light.svg'

// Brand-compliant logo wrapper with enhanced styling
const BrandProLogo = props => (
  <div
    style={{
...
/**
 * LandingPagePro component - Creates a brand-compliant landing page for Resolve Actions Pro
 *
 * @param {Object} props Component props
 * @returns {JSX.Element} LandingPagePro component
 */
const LandingPagePro = ({
  // Props with default values - updated to use brand colors
  headerTitle = 'RESOLVE ACTIONS PRO',
  headerLogoHeight = 50,
  welcomeBannerProps = {
  ...
  return (
    <>
      ...
      <style>
        ...
        /* Brand-compliant link styling - Pro uses green theme */
        ...
        /* Pro-specific brand enhancement for logo */
        .pro-logo-container {
          filter: brightness(1.1);
          transition: all 0.3s ease;
