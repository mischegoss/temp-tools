...
import { learningPaths } from '@site/src/components/Data/LearningPathsExpress'

// Import the SVG directly inside the component
import ExpressLogo from '@site/static/img/Resolve-Actions-Express-Light.svg'

// Brand-compliant logo wrapper with enhanced styling
const WhiteExpressLogo = props => (
  <div
    style={{
...
/**
 * LandingPageExpress component - Creates a brand-compliant landing page for Resolve Actions Express
 *
 * @param {Object} props Component props
 * @returns {JSX.Element} LandingPageExpress component
 */
const LandingPageExpress = ({
  // Props with default values - updated to use professional blue colors
  headerTitle = 'RESOLVE ACTIONS EXPRESS',
  headerLogoHeight = 50,
  welcomeBannerProps = {
    title: 'New to Resolve Actions Express? Check out these courses.',
    buttons: [
      {
  ...
  welcomeSectionProps = {
    ...
    content:
      "Explore our specialized learning paths designed to help you master Resolve Actions Express. Whether you're just getting started, managing the platform, or developing custom solutions, we have the perfect learning path for you.",
  },
  filterSectionProps = {
  ...
  return (
    <>
      ...
      {/* Header with the Express logo */}
      <MainStylizedHeader
        title={headerTitle}
        logo={WhiteExpressLogo}
      ...
      <style>
        ...
        /* Express-specific brand enhancement for logo */
        .express-logo-container {
          filter: brightness(1.1);
          transition: all 0.3s ease;
        }

        .express-logo-container:hover {
...
export default LandingPageExpress
