...
import heroStyles from './styles/herostyles1-light-three-across.js'
  ...
  return (
    <section style={heroStyles.heroSectionStyle} className='brand-font'>
      ...
      <div style={heroStyles.containerStyle}>
        ...
        <div style={heroStyles.cardGridStyle}>
            ...
            >
              ...
              >
                <div style={heroStyles.iconContainerStyle}>
                  <div style={heroStyles.lightIconStyle}>{iconMap[index]}</div>
                </div>
