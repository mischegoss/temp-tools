...
export const homePageData = [
  ...
  },
  {
    ...
    icon: <LearningIcon />,
    link: 'https://training.resolve.io/', // Fixed: Full URL
  },
  {
    title: 'Automation Exchange',
    description: 'Discover workflows and activities',
    icon: <AutomationIcon />,
    link: 'https://exchange.resolve.io/#/login', // Fixed: Full URL
  },
  {
    title: 'Support',
    description: 'Get help with product issues',
    icon: <SupportIcon />,
    link: 'https://support.resolve.io/login/user', // Fixed: Full URL
  },
]
